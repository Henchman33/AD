...
.DESCRIPTION
    ...
    Exports three deliverables to %USERPROFILE%\Desktop\DFS_Export (auto-created):
      ...
      3. HTML - light-themed interactive report with live search and collapsible sections
...
<style>
:root{
  --bg0:#f4f7fb;--bg1:#ffffff;--bg2:#fbfcfe;--bg3:#edf3f9;
  --blue:#1f6fb2;--blue-dark:#dcecff;--blue-mid:#c9e2fb;
  --green:#1f8f4d;--green-bg:#eaf7ef;--green-bd:#b7dfc6;
  --amber:#9a6a00;--amber-bg:#fff5d8;
  --red:#c33a32;--red-bg:#fff0ee;--red-bd:#efc2bd;
  --purple:#6e45b8;--purple-bg:#f2ecff;--purple-bd:#d8c8f3;
  --teal:#167b60;
  --txt:#17202a;--txt2:#5e6b7a;
  --bd:#d6dde7;--bd2:#1f6fb244;
  --shadow:0 2px 12px rgba(30,51,78,.12);
  --r:8px;--r2:4px;
}
...
/* â”€â”€ HEADER â”€â”€ */
.pg-hdr{
  background:linear-gradient(135deg,#ffffff 0%,var(--blue-dark) 100%);
...
/* â”€â”€ MAIN â”€â”€ */
.main{padding:20px 24px 60px;max-width:2400px;margin:0 auto}
...
.btn:hover{border-color:var(--blue);color:var(--blue);background:#eaf4ff}

/* â”€â”€ NAMESPACE CARD â”€â”€ */
.ns-card{
...
.t-srv{background:#eaf4ff;color:var(--blue);border:1px solid #bfd8f2}
.t-pri{background:var(--purple-bg);color:var(--purple);border:1px solid var(--purple-bd)}

/* â”€â”€ ACL TABLE â”€â”€ */
.acl-tbl{width:100%;min-width:1180px;border-collapse:collapse;font-size:11px}
.acl-tbl th{
  background:var(--blue-dark);color:#225f99;padding:6px 10px;
...
.acl-tbl tr:nth-child(even) td{background:#f7faff}
.acl-tbl tr:hover td{background:var(--bg3)}
.c-id{font-family:'Consolas','Courier New',monospace;color:#243447}
.c-sam{color:var(--blue);font-weight:500}
.c-rts{color:var(--txt2);max-width:420px;word-break:break-word}
...
.gt-dl {background:#eaf4ff;color:var(--blue);border:1px solid #bfd8f2}
