...
<#
.SYNOPSIS
    AD Forest Inventory, Health Dashboard & Topology Map Generator â€” v3.0
...
.DESCRIPTION
    ...
    Exports five output types, all to the current user's Desktop:
      1. HTML  â€” Interactive collapsible dashboard with live search
      2. CSV   â€” One .csv file per data category (12 files total)
      3. XLSX  â€” Multi-sheet Excel workbook via Excel COM (requires Excel)
      4. SVG   â€” Full AD forest / OU topology map (always generated)
      5. VSD   â€” Visio diagram via COM (generated only if Visio is installed)
    ...
    Platform : PowerShell ISE / PowerShell Console â€” Windows only
...
.PARAMETER MaxOUDepth
    ...
    appear in the HTML and CSV â€” only the visual map is capped.
...
.NOTES
    Author  : Stephen McKee â€” Server Administrator 2  (Enhanced v3.0)
    Version : 3.0
    Fixes from v2.0:
...
param(
    ...
    [Parameter(Mandatory = $false)]
    [string]$Author = "$env:USERNAME â€ Server Administrator 2",
...
#  REGION 1 â€” INITIALISE FOLDERS & LOGGING
# â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•
...
Write-Log "  AD Forest Inventory v3.0 â€” Starting" -Level SUCCESS
...
# â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•
#  REGION 2 â€” PREREQUISITES CHECK
# â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•
...
# Classify a container/OU by its name â€” returns type, hex color, short icon label
function Get-OUPurpose {
    ...
    if ($n -match '\btier.?0\b|\bt0\b')                 { return [PSCustomObject]@{ Type='Tier 0 â�� Privileged Admin';   Color='#6C3483'; TxtColor='#FFFFFF'; Icon='T0'  } }
    if ($n -match '\btier.?1\b|\bt1\b')                 { return [PSCustomObject]@{ Type='Tier 1 â�� Servers';            Color='#1A5276'; TxtColor='#FFFFFF'; Icon='T1'  } }
    if ($n -match '\btier.?2\b|\bt2\b')                 { return [PSCustomObject]@{ Type='Tier 2,â�� Workstations';       Color='#1E8449'; TxtColor='#FFFFFF'; Icon='T2'  } }
...
# â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•
#  REGION 4 â€” DATA COLLECTION
# â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•

# â”€â”€ 4a. Forest & Domain â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
...
# â”€â”€ 4b. Domain Controllers â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
...
# â”€â”€ 4c. Sites & Replication â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
...
# â”€â”€ 4d. PRE-FETCH ALL OBJECTS FOR EFFICIENT OU MAPPING â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
...
# â”€â”€ 4e. DEEP OU / CONTAINER INVENTORY â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
...
Write-Log "Container inventory complete â€” $($ouInventory.Count) containers catalogued." -Level SUCCESS

# â”€â”€ 4f. USER ACCOUNT HEALTH â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
...
# â”€â”€ 4g. COMPUTER INVENTORY â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
...
Write-Log "Computer inventory: $($computerData.Count) total â€” DCs: $(($computerData | Where-Object {$_.Role -eq 'Domain Controller'}).Count), Servers: $(($computerData | Where-Object {$_.Role -eq 'Member Server'}).Count), Workstations: $(($computerData | Where-Object {$_.Role -eq 'Workstation'}).Count)" -Level SUCCESS

# â”€â”€ 4h. SECURITY GROUPS â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
...
# â”€â”€ 4i. FINE-GRAINED PASSWORD POLICIES â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
...
# â”€â”€ 4j. GROUP POLICY â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
...
# â”€â”€ 4k. DNS ZONES â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
...
# â”€â”€ 4l. DHCP SCOPES â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
...
# â”€â”€ 4m. PKI / CERTIFICATES â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
...
# â”€â”€ 4n. PRIVILEGED GROUPS â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
...
# â”€â”€ 4o. SECURITY ALERTS â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
...
# â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•
#  REGION 6 â€” EXPORT: EXCEL WORKBOOK (via COM â€” requires Excel)
# â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•
...
# â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•
#  REGION 7 â€” EXPORT: SVG FOREST TOPOLOGY MAP
# â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•
...
# â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•
#  REGION 8 â€” EXPORT: VISIO DIAGRAM (COM â€” requires Visio)
# â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•
...
# â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•
#  REGION 9 â€” EXPORT: HTML DASHBOARD
# â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•
...
# â”€â”€ HTML helper: build a table from PSCustomObjects â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
...
# â”€â”€ OU Inventory with purpose color tiles â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
...
<title>AD Inventory â€” $DomainFQDN</title>
<style>
  :root {
    --bg:        #0F1923;
    --panel:     #162232;
...
<div class="topbar">
  <div>
    <div class="topbar-title">ðŸ› AD Forest Inventory Dashboard</div>
    <div class="topbar-domain">$DomainFQDN &nbsp;|&nbsp; Forest: $($forest.Name) &nbsp;|&nbsp; $reportDate</div>
  </div>
  <div class="topbar-spacer"></div>
  <button class="btn-clear" id="btnClear" title="Clear search">âœ•</button>
  <input id="searchBox" type="text" placeholder="ðŸ”  Search all sectionsâ€¦">
