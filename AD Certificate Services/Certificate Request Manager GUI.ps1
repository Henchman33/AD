...
# ------------------------------------------------------------------------------------
$script:ConfigPath = Join-Path $PSScriptRoot 'CertRequestManager.config.json'

function Get-ToolConfig {
    $default = [ordered]@{
        CAConfig       = 'USRNOPPKICA01.MYIGT.COM\MYIGT-ISSUING-CA'
        BasePath       = 'C:\PKI\CertRequests'
        DomainSuffixes = @('igtsap.ad.igt.com', 'ad.igt.com', 'is.ad.igt.com', 'mygt.com')
    }
...
<Window xmlns="http://schemas.microsoft.com/winfx/2006/xaml/presentation"
        ...
        Title="Cert Request Manager - Issuing CA" Height="880" Width="1080"
        WindowStartupLocation="CenterScreen" Background="#1E1E2E" FontFamily="Segoe UI">
    <Window.Resources>
        ...
        <Style TargetType="Button">
            ...
            <Setter Property="Cursor" Hand="True"/>
        </Style>
    ...
    <Grid Margin="14">
        ...
        <TextBlock Grid.Row="0" Text="Cert Request Manager" FontSize="20" FontWeight="Bold"
                   Foreground="{StaticResource TextMain}" Margin="0,0,0,10"/>
        ...
        <GroupBox Grid.Row="2" Header="CSR Source" Padding="10">
            <Grid>
                ...
                <StackPanel Grid.Row="1" Grid.Column="0" Grid.ColumnSpan="2" Margin="0,8,0,0">
                    ...
                    <TextBox x:Name="TxtCsrPaste" Height="70" AcceptsReturn="True" TextWrapping="Wrap"
        ...
        <GroupBox Grid.Row="3" Header="Subject Alternative Names (SAN.inf)" Padding="10">
            <StackPanel>
                <DataGrid x:Name="GridSan" Height="130" AutoGenerateColumns="False" CanUserAddRows="False">
                    <DataGrid.Columns>
        ...
        <StatusBar Grid.Row="5" Background="#181825" Margin="0,10,0,0">
            <StatusBarItem>
                <TextBlock x:Name="TxtStatus" Text="Ready." Foreground="#CDD6F4"/>
            </StatusBarItem>
        </StatusBar>
    </Grid>
</Window>
