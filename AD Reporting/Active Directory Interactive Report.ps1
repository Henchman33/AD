<#
.SYNOPSIS
    Generate Interactive graphed report for all Active Directory objects.
...
.PARAMETER CompanyLogo
    ...
    -CompanyLogo "https://avatars.githubusercontent.com/u/178410939?v=4"

.PARAMETER RightLogo
    Enter URL or UNC path to your desired right-side logo for generated report.

    -RightLogo "https://avatars.githubusercontent.com/u/178410939?v=4"

.PARAMETER ReportTitle
    Enter desired title for generated report.

    -ReportTitle "Active Directory Interactive Report"
...
param (
	...
	[Parameter(ValueFromPipeline = $true, HelpMessage = "https://avatars.githubusercontent.com/u/178410939?v=4")]
	[String]$CompanyLogo = "",
	...
	[String]$RightLogo = "https://avatars.githubusercontent.com/u/178410939?v=4",
	#Title of generated report

	[Parameter(ValueFromPipeline = $true, HelpMessage = "Enter desired title for report")]
	[String]$ReportTitle = "Active Directory Interactive Report",
	...
	[String]$ReportSavePath = "C:\ReportAutomation\",
	...
	[Parameter(ValueFromPipeline = $true, HelpMessage = "Users that have been created within [X] amount of days; Default: 10")]
	$UserCreatedDays = 7,
	#Get users whos passwords expire in less than X amount of days

	[Parameter(ValueFromPipeline = $true, HelpMessage = "Users password expires within [X] amount of days; Default: 10")]
	$DaysUntilPWExpireINT = 7,
	#Get AD Objects that have been modified in X days and newer

	[Parameter(ValueFromPipeline = $true, HelpMessage = "AD Objects that have been modified within [X] amount of days; Default: 10")]
	$ADModNumber = 3
