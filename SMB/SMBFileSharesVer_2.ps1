<# Update/Enhancement to HTML Report
Removed the prompt asking if the user wants to open the report
Added automatic opening using Start-Process $htmlFile
Added error handling in case the browser fails to open
Added confirmation message that the report is opening
#>
# Domain SMB Shares Report Generator Version 2
