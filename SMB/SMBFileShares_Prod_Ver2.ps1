    ...
    <script>
        $(document).ready(function() {
            ...
            function applyHighlights(searchTerm) {
                ...
                // Escape special regex characters// Instead of the complex regex escape, use a simpler approach:
...
try {
    ...
    Write-Host "B000m!!! HTML report opened successfully!" -ForegroundColor Green
}
catch {
...
Write-Host "File Shares/SMB Script completed successfully!" -ForegroundColor Green
